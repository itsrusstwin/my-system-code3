...
@section('content')
    <h1 class="text-2xl font-bold text-blue-700 mb-6">Add Position</h1>

    <form method="POST" action="{{ route('positions.store') }}" class="bg-white p-6 rounded shadow space-y-4">
        @csrf
        <div>
